...
SWIGEXPORT SEXP
R_swig_circle_area ( SEXP r, SEXP s_swig_copy)
{
  double result;
  double arg1 ;
  ...
  result = (double)circle_area(arg1);
...
SWIGEXPORT SEXP
R_swig_circle_perimeter ( SEXP r, SEXP s_swig_copy)
{
  double result;
  double arg1 ;
  unsigned int r_nprotect = 0;
  ...
  arg1 = static_cast< double >(REAL(r)[0]);
  result = (double)circle_perimeter(arg1);
  r_ans = SWIG_From_double(static_cast< double >(result));
  vmaxset(r_vmax);
  if(r_nprotect)  Rf_unprotect(r_nprotect);
...
extern "C" SWIGEXPORT void R_init_swigr(DllInfo *dll) {
